...
function HomeTab() {
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      items.map(
        ({ label, url, icon }) => React.createElement(
          "a",
          { key: label, href: url, className: "panel-chip" },
...
function RecentTab() {
  ...
  return React.createElement(
    ...
    items.map(
      ({ title, time, url }) => React.createElement(
        "a",
        { key: title, href: url, className: "panel-row" },
